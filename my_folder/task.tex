...
%	\printbibliographyTask % печать списка источников % КОММЕНТИРУЕМ ЕСЛИ НЕ ИСПОЛЬЗУЕТСЯ
	...
	\begin{enumerate}[label=\theenumi\arabic*.]
		\item Разработка архитектуры информационной системы
		\item Исследование и сравнительный анализ существующих технологий разработки
		\item Разработка программного обеспечения в рамках разработанной архитектуры
		\item Развертывание
		\item Тестирование системы с использованием метрик
	\end{enumerate}
	\item Перечень графического материала (с указанием обязательных чертежей): 
	\begin{enumerate}[label=\theenumi\arabic*.]
		\item Графики, построенные на основе данных о производительности и отказоустойчивости сервиса
	\end{enumerate}
