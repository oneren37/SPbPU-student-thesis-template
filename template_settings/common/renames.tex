...
\newcommand{\Supervisor}{Е.Е.\,Андрианова} % И. О. Фамилия научного руководителя
\newcommand{\SupervisorFull}{Андрианова Екатерина Евгеньевна} % Фамилия Имя Отчество научного руководителя
\newcommand{\SupervisorVin}{Е.Е.\,Андрианову} % И. О. Фамилия научного руководителя  в винительном падеже (Кого? что? Руководителя ...)
\newcommand{\SupervisorJob}{старший преподаватель ВШИИ} %
\newcommand{\SupervisorJobVin}{старшего преподавателя ВШИИ} % в винительном падеже (Кого? что?  Програмиста ...)
...
%%% Первый консультант
%\newcommand{\ConsultantExtraFull}{Хахина Анна Михайловна} % Фамилия Имя Отчетство дополнительного консультанта
%\newcommand{\ConsultantExtra}{А.М.\,Хахина} % И. О. Фамилия дополнительного консультанта
%\newcommand{\ConsultantExtraDegree}{профессор ВШ ИСиСТ} %
%\newcommand{\ConsultantExtraVin}{А.М.\,Хахину} % И. О. Фамилия дополнительного консультанта в винительном падеже (Кого? что? Руководителя ...)
%\newcommand{\ConsultantExtraDegreeVin}{профессора ВШ ИСиСТ} %  в винительном падеже (Кого? что? Руководителя ...)
%%% Второй консультант
...
\newcommand{\thesisDeadline}{19.05.2024}
...
%\newcommand{\abstractRu}{Предметом исследования является разработка системы цифровых вывесок} % ВВЕДИТЕ текст аннотации по-русски
%%
%%
